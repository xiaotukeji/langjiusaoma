 ...
 * 管理员管理
 */
class Officer extends Adminbase
{
    protected $searchFields     = 'id,realname,mobile,gonghao';
    protected $childrenGroupIds = [];
    protected $childrenAdminIds = [];
    protected function initialize()
    {
        parent::initialize();
        $this->modelClass = new Admin_Officer;
...
/*            foreach ($list as $k => &$v) {
    ...
    public function add()
    {
        $officer_model =   new Admin_Officer();
